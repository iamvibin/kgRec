...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', type=str, dest='train_file', default='data/ml/recommend_targets.txt')
    parser.add_argument('--test', type=str, dest='test_file', default='data/ml/recommend_truth.txt')
